...
export default class Main extends Component{
    ...
    render(){
        ...
        return(<div>
            ...
            {guion !== this.state.circuito[actual]['nombre'].length? 'Manguera' + <Typography variant='h3'>{this.state.circuito[this.state.actualCircuito]['nombre'].substr(guion+1,3)}</Typography>:null}<br/>
